        ...
        if game_state.turn_number == 0:
            ...
            if game_state.get_resource(MP) < 18:
                ...
                if self.detect_enemy_unit(game_state, None, valid_x = {i for i in range(0, 28)}, valid_y = [14, 15, 16]) >= 30 and game_state.get_resource(SP) >= 54:
                    ...
                    if self.algo3_counter % 3 == 0 and (self.detect_enemy_unit(game_state, WALL, valid_x = {i for i in range(0, 28)}, valid_y = {i for i in range(14, 28)}) >= 20 or self.detect_enemy_unit(game_state, TURRET, valid_x = {i for i in range(0, 28)}, valid_y = {i for i in range(14, 28)}) >= 16):
